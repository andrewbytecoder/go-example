...
const (
	SendMessage_SendMessage_FullMethodName = "/proto.SendMessage/SendMessage"
)
...
func (c *sendMessageClient) SendMessage(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
...
func (UnimplementedSendMessageServer) SendMessage(context.Context, *Request) (*Response, error) {
...
func _SendMessage_SendMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SendMessageServer).SendMessage(ctx, req.(*Request))
	}
